...
@AllArgsConstructor
@Builder
public class TransactionTable extends PanacheEntityBase {
    ...
    @Column(name = "settled_at_p2m")
    public Date settledAtP2m;

    @Column(name="is_settled_at_p2m")
    public Boolean boolSettledAtP2m;

    @Column(name="settlement_id")
    public String settlementId;

    @Column(name="isEod")
    public Boolean boolisEod;
}
