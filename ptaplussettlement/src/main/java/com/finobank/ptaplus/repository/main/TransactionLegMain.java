package com.finobank.ptaplus.repository.main;
...
@ApplicationScoped
@Transactional
public class TransactionLegMain implements PanacheRepository<TransactionTable> {
    ...
    @Transactional
    public void updateSettledStatus(String partnerGl, String thresholdamt, Date createdDate, String settlementId) {
